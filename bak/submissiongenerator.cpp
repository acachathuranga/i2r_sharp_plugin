...
SubMissionGenerator::SubMissionGenerator(boost::function<bool (QString)> sendTask, Console *console, RobotCommunication *com)
{
    sendTask_ = sendTask;
    console_ = console;
    com_ = com;
...
//        SubMission publish_robot_state(SUB_CMD(com_->publish(ROBOT_STATUS_TOPIC, ROBOT_STATUS_FIELD, ROBOT_STATUS_CHARGING)));
//        publish_robot_state.setDescription("Update Robot State");
//        enqueue(publish_robot_state);

//        // Publish Robot Location
//        SubMission publish_robot_location(SUB_CMD(com_->publish(ROBOT_LOCATION_TOPIC, ROBOT_LOCATION_FIELD, LOCATION_CHARGER)));
...
//       // Publish Robot Location
//       SubMission publish_robot_location(SUB_CMD(com_->publish(ROBOT_LOCATION_TOPIC, ROBOT_LOCATION_FIELD, LOCATION_HALLWAY)));
//       publish_robot_location.setDescription("Update Robot Location");
//       enqueue(publish_robot_location);

//       // Go to Bed
//       navigate = SubMission(SUB_CMD(sendTask_, LF_HALLWAY_TO_BED_PREFIX + bed_id_));
//       navigate.addFallbackTask(SUB_CMD(sendTask_, LF_BED_TO_HALLWAY_PREFIX + bed_id_));
//       navigate.setDescription("Go to Bed Location");
//       enqueue(navigate);

//       // Publish Robot Location
//       publish_robot_location = SubMission(SUB_CMD(com_->publish(ROBOT_LOCATION_TOPIC, ROBOT_LOCATION_FIELD, LOCATION_BED_PREFIX + bed_id_)));
//       publish_robot_location.setDescription("Update Robot Location");
//       enqueue(publish_robot_location);
...
//       // Publish Robot Status
//       SubMission publish_robot_state(SUB_CMD(com_->publish(ROBOT_STATUS_TOPIC, ROBOT_STATUS_FIELD, ROBOT_STATUS_IDLE)));
//       publish_robot_state.setDescription("Update Robot State");
//       enqueue(publish_robot_state);

//       // Publish Robot Location
//       SubMission publish_robot_location(SUB_CMD(com_->publish(ROBOT_LOCATION_TOPIC, ROBOT_LOCATION_FIELD, LOCATION_PARKING)));
//       publish_robot_location.setDescription("Update Robot Location");
//       enqueue(publish_robot_location);
...
//       // Publish Robot Location
//       SubMission publish_robot_location(SUB_CMD(com_->publish(ROBOT_LOCATION_TOPIC, ROBOT_LOCATION_FIELD, LOCATION_BED_PREFIX + bed_id_)));
//       publish_robot_location.setDescription("Update Robot Location");
//       enqueue(publish_robot_location);
...
//       // Open Door
//       SubMission door_open(SUB_CMD(com_->publish(DOOR_CONTROL_TOPIC, DOOR_CONTROL_FIELD, DOOR_OPEN)));
//       door_open.addFallbackTask(SUB_CMD(com_->publish(DOOR_CONTROL_TOPIC, DOOR_CONTROL_FIELD, DOOR_CLOSE)));
...
//       // Close Door
//       SubMission door_open(SUB_CMD(com_->publish(DOOR_CONTROL_TOPIC, DOOR_CONTROL_FIELD, DOOR_CLOSE)));
//       door_open.addFallbackTask(SUB_CMD(com_->publish(DOOR_CONTROL_TOPIC, DOOR_CONTROL_FIELD, DOOR_OPEN)));

//       // Handover Payload to Manipulator
//       SubMission release_playload(SUB_CMD(sendTask_, RELEASE_PAYLOAD_TO_BED));
//       release_playload.setDescription("Handover Payload to Manipulator");
//       enqueue(release_payload);

//       // Publish Robot Location
//       SubMission publish_robot_location(SUB_CMD(com_->publish(ROBOT_LOCATION_TOPIC, ROBOT_LOCATION_FIELD, LOCATION_MANIPULATOR)));
//       publish_robot_location.setDescription("Update Robot Location");
//       enqueue(publish_robot_location);
